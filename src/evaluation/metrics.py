...
def compute_classification_metrics(
    ...
    *,
    ...
    return {
        ...
        "balanced_critical_f1": round(
            float((0.4 * per_class_f1[offensive_idx]) + (0.4 * per_class_f1[hate_idx]) + (0.2 * macro_f1)), 4
        ),
        "balanced_critical_recall": round(
            float(
                (0.4 * per_class_recall[offensive_idx])
                + (0.4 * per_class_recall[hate_idx])
                + (0.2 * macro_recall)
            ),
            4,
        ),
